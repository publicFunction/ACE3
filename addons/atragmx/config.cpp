class CfgPatches
{
	class ace_atragmx
	{
		...
		author="Ruthberg";
		version="3.0.0.2-e7c0b7e6";
		versionStr="3.0.0.2-e7c0b7e6";
		versionAr[]={3,0,0,2};
	};
};
class Extended_PreInit_EventHandlers
{
	class ace_atragmx
	{
		init=" call compile preProcessFileLineNumbers '\z\ace\addons\atragmx\XEH_preInit.sqf' ";
	};
};
class Extended_PostInit_EventHandlers
{
	class ace_atragmx
	{
		init=" call compile preProcessFileLineNumbers '\z\ace\addons\atragmx\XEH_postInit.sqf' ";
	};
};
class CfgVehicles
{
...
class CfgWeapons
{
	...
	class ACE_ATragMX: ACE_ItemCore
	{
		...
		model="\z\ace\addons\atragmx\data\tdsrecon.p3d";
		picture="\z\ace\addons\atragmx\UI\ATRAG_Icon.paa";
...
class ATragMX_RscToolbox
{
	...
	colorText[]={0,0,0,1};
	color[]={0,0,0,0};
	colorTextSelect[]={0.80000001,0.80000001,0.80000001,1};
	colorSelect[]={0,0,0,1};
...
class ATragMX_RscListBox
{
	...
	colorSelectBackground[]={0.92500001,0.92500001,0.92500001,1};
	colorSelectBackground2[]={0.92500001,0.92500001,0.92500001,1};
	period=0;
	maxHistoryDelay=1;
	autoScrollSpeed=-1;
	autoScrollDelay=5;
...
class ATragMX_RscListNBox: ATragMX_RscListBox
{
	idc=-1;
	type=102;
	columns[]={0,0.22499999,0.47499999,0.69999999};
	drawSideArrows=0;
	idcLeft=-1;
	idcRight=-1;
};
...
class ATragMX_Display
{
	...
	class controls
	{
		class BACKGROUND
		{
			...
			colorBackground[]={1,1,1,1};
			colorText[]={1,1,1,1};
			text="\z\ace\addons\atragmx\UI\atrag.paa";
		};
		...
		class BACK: POWER
		{
			...
			action="call ace_atragmx_fnc_init; call ace_atragmx_fnc_update_target_selection";
		};
		...
		class TOP: ATragMX_RscButton
		{
			...
			h=0.029999999;
			colorBackground[]={0,0,0,0};
			action="-1 call ace_atragmx_fnc_cycle_gun_list";
		};
		class BOTTOM: TOP
		{
			idc=-1;
		...
		class LEFT: ATragMX_RscButton
		{
			...
			h=0.029999999;
			colorBackground[]={0,0,0,0};
			action="((4 + ace_atragmx_currentTarget - 1) % 4) call ace_atragmx_fnc_change_target_slot";
		};
		class RIGHT: LEFT
		{
			idc=-1;
		...
		class TEXT_D: ATragMX_RscButton
		{
			...
			y="0.265*safezoneH+safezoneY+0.20";
			colorText[]={0,0,0,1};
			colorDisabled[]={0.80000001,0.80000001,0.80000001,1};
			colorBackgroundDisabled[]={0,0,0,1};
			colorBackgroundActive[]={0,0,0,0};
			text="D";
			action="ace_atragmx_currentUnit=0; call ace_atragmx_fnc_update_unit_selection";
		};
		class TEXT_E: TEXT_D
		{
			idc=601;
			...
			text="E";
			action="ace_atragmx_currentUnit=1; call ace_atragmx_fnc_update_unit_selection";
		};
		class TEXT_M: TEXT_E
		{
			idc=602;
			...
			text="M";
			action="ace_atragmx_currentUnit=2; call ace_atragmx_fnc_update_unit_selection";
		};
		class TEXT_RANGE_CARD: TEXT_D
		{
			...
			colorBackground[]={0.15000001,0.20999999,0.23,0.30000001};
			colorFocused[]={0.15000001,0.20999999,0.23,0.2};
			text="RC";
			action="call ace_atragmx_fnc_toggle_range_card";
		};
		class TEXT_GUN: ATragMX_RscButton
		{
			...
			colorFocused[]={0.15000001,0.20999999,0.23,0.2};
			text="Gun";
			action="call ace_atragmx_fnc_toggle_gun_ammo_data";
		};
		...
		class TEXT_ATMOSPHERE: TEXT_GUN
		{
			...
			x="0.550*safezoneW+safezoneX+0.205";
			text="Atmsphr";
			action="0 call ace_atragmx_fnc_toggle_atmo_env_data";
		};
		...
		class TEXT_TARGET_A: ATragMX_RscButton
		{
			...
			colorBackgroundActive[]={0,0,0,0};
			text="A";
			action="0 call ace_atragmx_fnc_change_target_slot";
		};
		class TEXT_TARGET_B: TEXT_TARGET_A
		{
			...
			text="B";
			action="1 call ace_atragmx_fnc_change_target_slot";
		};
		class TEXT_TARGET_C: TEXT_TARGET_A
		{
			...
			text="C";
			action="2 call ace_atragmx_fnc_change_target_slot";
		};
		class TEXT_TARGET_D: TEXT_TARGET_A
		{
			...
			text="D";
			action="3 call ace_atragmx_fnc_change_target_slot";
		};
		class TEXT_TARGET: TEXT_GUN
		{
			...
			x="0.550*safezoneW+safezoneX+0.3";
			text="Target";
			action="0 call ace_atragmx_fnc_toggle_target_data";
		};
		...
		class TEXT_TARGET_SPEED: TEXT_MUZZLE_VELOCITY
		{
			...
			x="0.550*safezoneW+safezoneX+0.3";
			text="TS";
			action="0 call ace_atragmx_fnc_toggle_target_speed_assist";
		};
		...
		class TEXT_TARGET_RANGE: TEXT_TARGET_SPEED
		{
			...
			y="0.265*safezoneH+safezoneY+0.425";
			text="TR";
			action="0 call ace_atragmx_fnc_toggle_target_range_assist";
		};
		...
		class TEXT_LEAD: TEXT_GUN
		{
			...
			text="Lead";
			action="ace_atragmx_showWind2 = !ace_atragmx_showWind2; call ace_atragmx_fnc_update_result; call ace_atragmx_fnc_update_target";
		};
		...
		class TEXT_RESET_SCOPE_ZERO: TEXT_GUN
		{
			...
			y="0.265*safezoneH+safezoneY+0.57";
			text="Reset";
			action="call ace_atragmx_fnc_reset_relative_click_memory";
		};
		class TEXT_UPDATE_SCOPE_ZERO: TEXT_RESET_SCOPE_ZERO
		{
			...
			x="0.550*safezoneW+safezoneX+0.323";
			text="Update";
			action="call ace_atragmx_fnc_update_relative_click_memory";
		};
		class TEXT_GUN_LIST: TEXT_GUN
		{
			...
			text="GunList";
			action="call ace_atragmx_fnc_toggle_gun_list";
		};
		class TEXT_SCOPE_UNIT: TEXT_GUN_LIST
		{
			...
			colorBackground[]={0,0,0,0};
			text="TMOA";
			action="call ace_atragmx_fnc_cycle_scope_unit";
		};
		class TEXT_SCOPE_CLICK_NUMBER: TEXT_GUN_LIST
		{
			...
			text="4";
			action="call ace_atragmx_fnc_toggle_solution_setup";
		};
		class TEXT_CALCULATE: TEXT_SCOPE_UNIT
		{
			...
			x="0.550*safezoneW+safezoneX+0.3";
			text="Calc";
			action="call ace_atragmx_fnc_calculate_target_solution";
		};
		...
		class TEXT_RANGE_CARD_SETUP: ATragMX_RscButton
		{
			...
			colorFocused[]={0.15000001,0.20999999,0.23,0.2};
			text="Setup";
			action="call ace_atragmx_fnc_toggle_range_card_setup";
		};
		...
		class TEXT_RANGE_CARD_COLUMN_4_CAPTION: TEXT_RANGE_CARD_COLUMN_1_CAPTION
		{
			...
			text="TmFlt";
			action="call ace_atragmx_fnc_cycle_range_card_columns";
		};
		...
		class TEXT_GUN_LIST_OUTPUT: ATragMX_RscListBox
		{
			...
			y="0.265*safezoneH+safezoneY+0.24";
			sizeEx=0.025;
			colorSelectBackground[]={0.15000001,0.20999999,0.23,0.30000001};
			colorSelectBackground2[]={0.15000001,0.20999999,0.23,0.30000001};
			onMouseButtonDblClick="true call ace_atragmx_fnc_toggle_gun_list";
		};
		...
		class TEXT_GUN_LIST_OPEN_GUN: ATragMX_RscButton
		{
			...
			sizeEx=0.024;
			text="Open Gun";
			action="true call ace_atragmx_fnc_toggle_gun_list";
		};
		class TEXT_GUN_LIST_SAVE_GUN: TEXT_GUN_LIST_OPEN_GUN
		{
			...
			y="0.265*safezoneH+safezoneY+0.24";
			text="Save Gun";
			action="call ace_atragmx_fnc_save_gun";
		};
		class TEXT_GUN_LIST_ADD_NEW_GUN: TEXT_GUN_LIST_OPEN_GUN
		{
			...
			text="Add New Gun";
			action="false call ace_atragmx_fnc_show_gun_list; true call ace_atragmx_fnc_show_add_new_gun";
		};
		class TEXT_GUN_LIST_DELETE_GUN: TEXT_GUN_LIST_OPEN_GUN
		{
			...
			text="Delete Gun";
			action="call ace_atragmx_fnc_delete_gun";
		};
		...
		class TEXT_GUN_LIST_DONE: TEXT_GUN_LIST_OPEN_GUN
		{
			...
			y="0.265*safezoneH+safezoneY+0.65";
			text="Done";
			action="false call ace_atragmx_fnc_toggle_gun_list";
		};
		...
		class TEXT_TARGET_RANGE_ASSIST_WIDTH_HEIGHT: ATragMX_RscToolbox
		{
			...
			values[]={1,0};
			onToolBoxSelChanged="ace_atragmx_rangeAssistUseTargetHeight = ((_this select 1) == 0)";
		};
		...
		class TEXT_TARGET_RANGE_ASSIST_CALC_1: TEXT_MUZZLE_VELOCITY
		{
			...
			sizeEx=0.029999999;
			text="!";
			action="0 call ace_atragmx_fnc_calculate_target_range_assist";
		};
		class TEXT_TARGET_RANGE_ASSIST_CALC_2: TEXT_TARGET_RANGE_ASSIST_CALC_1
		{
			idc=7008;
			y="0.265*safezoneH+safezoneY+0.45";
			action="1 call ace_atragmx_fnc_calculate_target_range_assist";
		};
		class TEXT_TARGET_RANGE_ASSIST_CALC_3: TEXT_TARGET_RANGE_ASSIST_CALC_1
		{
			idc=7009;
			y="0.265*safezoneH+safezoneY+0.55";
			action="2 call ace_atragmx_fnc_calculate_target_range_assist";
		};
		...
		class TEXT_TARGET_RANGE_ASSIST_TARGET_SIZE_UNIT: TEXT_TARGET_RANGE_ASSIST_CALC_1
		{
			...
			x="0.550*safezoneW+safezoneX+0.32";
			text="cm";
			action="call ace_atragmx_fnc_cycle_target_size_units";
		};
		class TEXT_TARGET_RANGE_ASSIST_IMAGE_SIZE_UNIT: TEXT_TARGET_RANGE_ASSIST_TARGET_SIZE_UNIT
		{
			...
			y="0.265*safezoneH+safezoneY+0.45";
			text="MIL";
			action="call ace_atragmx_fnc_cycle_image_size_units";
		};
		...
		class TEXT_TARGET_RANGE_ASSIST_DONE: ATragMX_RscButton
		{
			...
			colorFocused[]={0.15000001,0.20999999,0.23,0.2};
			text="Done";
			action="1 call ace_atragmx_fnc_toggle_target_range_assist";
		};
		...
		{
			idc=8004;
			onKeyUp="if (_this select 1 == 28) then {call ace_atragmx_fnc_calculate_target_speed_assist}";
		};
		...
		class TEXT_TARGET_SPEED_ASSIST_NUM_TICKS_UNIT: TEXT_TARGET_RANGE_ASSIST_IMAGE_SIZE_UNIT
		{
			idc=8009;
			text="MIL";
			action="call ace_atragmx_fnc_cycle_num_ticks_units";
		};
		class TEXT_TARGET_SPEED_ASSIST_TIMER_START: TEXT_TARGET_RANGE_ASSIST_IMAGE_SIZE_UNIT
		{
			...
			y="0.265*safezoneH+safezoneY+0.5";
			text="Start";
			action="call ace_atragmx_fnc_target_speed_assist_timer";
		};
		...
		{
			idc=8012;
			action="1 call ace_atragmx_fnc_toggle_target_speed_assist";
		};
		...
		class TEXT_TARGET_SPEED_ASSIST_TIMER_STOP_BACKGROUND: ATragMX_RscButton
		{
			...
			colorBackground[]={0,0,0,0};
			colorBackgroundActive[]={0,0,0,0};
			action="ace_atragmx_speedAssistTimer=false";
		};
		...
		{
			idc=10003;
			onKeyUp="if (_this select 1 == 28) then {1 call ace_atragmx_fnc_toggle_range_card_setup}";
		};
		...
		{
			idc=10006;
			action="1 call ace_atragmx_fnc_toggle_range_card_setup";
		};
		class TEXT_RANGE_CARD_SETUP_CANCEL: TEXT_TARGET_SPEED_ASSIST_CANCEL
		{
			idc=10007;
			action="0 call ace_atragmx_fnc_toggle_range_card_setup";
		};
		...
		class TEXT_ADD_NEW_GUN_OK: ATragMX_RscButton
		{
			...
			colorFocused[]={0.15000001,0.20999999,0.23,0.2};
			text="OK";
			action="call ace_atragmx_fnc_add_new_gun; false call ace_atragmx_fnc_show_add_new_gun; true call ace_atragmx_fnc_show_gun_list";
		};
		class TEXT_ADD_NEW_GUN_CANCEL: TEXT_ADD_NEW_GUN_OK
		{
			...
			x="0.550*safezoneW+safezoneX+0.245";
			text="Cancel";
			action="false call ace_atragmx_fnc_show_add_new_gun; true call ace_atragmx_fnc_show_gun_list";
		};
		...
		{
			idc=12008;
			action="1 call ace_atragmx_fnc_toggle_gun_ammo_data";
		};
		class TEXT_GUN_AMMO_DATA_CANCEL: TEXT_TARGET_SPEED_ASSIST_CANCEL
		{
			idc=12009;
			action="0 call ace_atragmx_fnc_toggle_gun_ammo_data";
		};
		...
		class TEXT_ATMO_ENV_DATA_DEFAULT: TEXT_LEAD
		{
			...
			y="0.265*safezoneH+safezoneY+0.320";
			text="Default";
			action="call ace_atragmx_fnc_restore_atmo_default";
		};
		class TEXT_ATMO_ENV_DATA_AT: TEXT_TARGET_A
		{
			...
			y="0.265*safezoneH+safezoneY+0.320";
			text="AT";
			action="ace_atragmx_atmosphereModeTBH = false; call ace_atragmx_fnc_update_atmo_selection";
		};
		class TEXT_ATMO_ENV_DATA_TBH: TEXT_ATMO_ENV_DATA_AT
		{
			...
			x="0.550*safezoneW+safezoneX+0.28";
			text="TBH";
			action="ace_atragmx_atmosphereModeTBH = true; call ace_atragmx_fnc_update_atmo_selection";
		};
		...
		{
			idc=13007;
			action="1 call ace_atragmx_fnc_toggle_atmo_env_data";
		};
		...
		class TEXT_TARGET_DATA_INCLINATION_ANGLE_INPUT_COSINE: TEXT_TARGET_DATA_LATITUDE_INPUT
		{
			...
			x="0.550*safezoneW+safezoneX+0.290";
			y="0.265*safezoneH+safezoneY+0.440";
			onKeyUp="if (_this select 1 == 28) then {0 call ace_atragmx_fnc_update_inclination_angle}";
		};
		...
		class TEXT_TARGET_DATA_INCLINATION_ANGLE_INPUT_DEGREE: TEXT_TARGET_DATA_LATITUDE_INPUT
		{
			...
			x="0.550*safezoneW+safezoneX+0.350";
			y="0.265*safezoneH+safezoneY+0.440";
			onKeyUp="if (_this select 1 == 28) then {1 call ace_atragmx_fnc_update_inclination_angle}";
		};
		...
		class TEXT_TARGET_DATA_TARGET_SPEED_DIRECTION: ATragMX_RscButton
		{
			...
			y="0.265*safezoneH+safezoneY+0.480";
			text=">";
			action="call ace_atragmx_fnc_cycle_target_speed_direction";
		};
		...
		{
			idc=14008;
			action="1 call ace_atragmx_fnc_toggle_target_data";
		};
		...
		class TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_1: TEXT_TARGET_A
		{
			...
			y="0.265*safezoneH+safezoneY+0.35";
			text="1";
			action="ace_atragmx_currentScopeClickNumberTemp = 1; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_2: TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_1
		{
			...
			text="2";
			action="ace_atragmx_currentScopeClickNumberTemp = 2; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_3: TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_1
		{
			...
			x="0.550*safezoneW+safezoneX+0.22";
			text="3";
			action="ace_atragmx_currentScopeClickNumberTemp = 3; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_4: TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_1
		{
			...
			text="4";
			action="ace_atragmx_currentScopeClickNumberTemp = 4; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_8: TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_1
		{
			...
			text="8";
			action="ace_atragmx_currentScopeClickNumberTemp = 8; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_10: TEXT_SOLUTION_SETUP_SHOW_RESULT_IN_1
		{
			...
			text="10";
			action="ace_atragmx_currentScopeClickNumberTemp = 10; call ace_atragmx_fnc_update_solution_setup";
		};
		...
		class TEXT_SOLUTION_SETUP_CLICKS_PER_TMOA: TEXT_TARGET_A
		{
			...
			y="0.265*safezoneH+safezoneY+0.45";
			text="TMOA";
			action="ace_atragmx_currentScopeClickUnitTemp = 0; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_CLICKS_PER_SMOA: TEXT_SOLUTION_SETUP_CLICKS_PER_TMOA
		{
			...
			text="SMOA";
			action="ace_atragmx_currentScopeClickUnitTemp = 1; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_CLICKS_PER_MILS: TEXT_SOLUTION_SETUP_CLICKS_PER_TMOA
		{
			...
			text="MILS";
			action="ace_atragmx_currentScopeClickUnitTemp = 2; call ace_atragmx_fnc_update_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_DONE: TEXT_TARGET_SPEED_ASSIST_DONE
		{
			...
			x="0.550*safezoneW+safezoneX+0.18";
			y="0.265*safezoneH+safezoneY+0.55";
			action="1 call ace_atragmx_fnc_toggle_solution_setup";
		};
		class TEXT_SOLUTION_SETUP_CANCEL: TEXT_TARGET_SPEED_ASSIST_CANCEL
		{
			...
			x="0.550*safezoneW+safezoneX+0.26";
			y="0.265*safezoneH+safezoneY+0.55";
			action="0 call ace_atragmx_fnc_toggle_solution_setup";
		};
	};
};
